...
let music = new Audio('Weekend/1.mp3')
...
let songs = [
    ...
    {
        id: 5,
        songName: `I was Never There <br> <div class="subtitle">The Weekend</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
    ...
    {
        id: 7,
        songName: `Die for You <br> <div class="subtitle">The Weekend, Ariana Grande</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Save your Tears<br> <div class="subtitle">The Weekend</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Earned It <br> <div class="subtitle">The Weekend</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `Called out my Name <br> <div class="subtitle">The Weekend</div>`,
        poster: "10.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Weekend/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Weekend/${index}.mp3`;
    poster_master_play.src = `Weekend/${index}.jpg`;
    title_card.src = `Weekend/${index}.jpg`
    banner.style.backgroundImage = `url('Weekend/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Weekend/${index}.mp3`;
