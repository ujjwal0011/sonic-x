...
let music = new Audio('Hot Hits/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Tere Pyaar Mein <br> <div class="subtitle">Arijit Singh, Nikita Gandhi</div>`,
        poster: "1.jpg"
    },
    {
        id: 2,
        songName: `Har Funn Maula <br> <div class="subtitle">Vishal Dadlani & Zara Khan</div>`,
        poster: "2.jpg"
    },
    {
        id: 3,
    ...
    {
        id: 5,
        songName: `Bhool Bhulaiyaa <br> <div class="subtitle">Neeraj Shridhar</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
        songName: `Ride It<br> <div class="subtitle">Jay Sean</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
    ...
    {
        id: 9,
        songName: `Aaj Ke Baad <br> <div class="subtitle">Manan Bhardwaj</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `Darkhaast <br> <div class="subtitle">Arijit Singh, Sunidhi Chauhan</div>`,
        poster: "10.jpg"
    },
    {
        id: 11,
        songName: `Aashiq Banaya Aapne <br> <div class="subtitle">Himesh Reshammiya & Neha Kakkar</div>`,
        poster: "11.jpg"
    },
    {
        id: 12,
        songName: `Marjaani <br> <div class="subtitle">Sukhwinder Singh & Sunidhi Chauhan</div>`,
        poster: "12.jpg"
    },
    {
        id: 13,
        songName: `Chammak Challo <br> <div class="subtitle"> Akon & Hamsika Iyer</div>`,
        poster: "13.jpg"
    },
    {
        id: 14,
        songName: `Urvashi <br> <div class="subtitle">Yo Yo Honey Singh</div>`,
        poster: "14.jpg"
    },
    {
        id: 15,
        songName: `Kaala Jaadu <br> <div class="subtitle">Arijit Singh & Nikhita Gandh</div>`,
        poster: "15.jpg"
    },
    {
        id: 16,
        songName: `Rait Zara Si - Gibberish <br> <div class="subtitle">AR Rahman</div>`,
        poster: "16.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Hot Hits/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Hot Hits/${index}.mp3`;
    poster_master_play.src = `Hot Hits/${index}.jpg`;
    title_card.src = `Hot Hits/${index}.jpg`
    banner.style.backgroundImage = `url('Hot Hits/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Hot Hits/${index}.mp3`;
