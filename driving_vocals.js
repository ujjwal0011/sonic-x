...
let music = new Audio('Driving Vocals/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Drunk N Nasty x Skeletons<br> <div class="subtitle">Prod. vmeshbeats</div>`,
        poster: "1.jpg"
    }
    ,
    {
        id: 2,
        songName: `Metamorphosis <br> <div class="subtitle">Interworld</div>`,
        poster: "2.jpg"
    },
    {
        id: 3,
        songName: `Sleepwalker <br> <div class="subtitle">Akiaura, Lonwon, STM</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `Under The Influence x I Was Never There <br> <div class="subtitle">Chris Brown, The Weekend</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
        songName: `Fluxxwave<br> <div class="subtitle">Anti, Clovis Reyes</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
        songName: `The Lost Soul Down X Lost soul<br> <div class="subtitle">NBSPLV</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `Divine Hell - Immortal<br> <div class="subtitle">Playboi Carti, Lemuel Tay</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Megaphunk<br> <div class="subtitle">Dashie · ISXRO</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Fukumean <br> <div class="subtitle">Gunna</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `Renegade<br> <div class="subtitle">Aaryan Shah</div>`,
        poster: "10.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Driving Vocals/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Driving Vocals/${index}.mp3`;
    poster_master_play.src = `Driving Vocals/${index}.jpg`;
    title_card.src = `Driving Vocals/${index}.jpg`
    banner.style.backgroundImage = `url('Driving Vocals/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Driving Vocals/${index}.mp3`;
