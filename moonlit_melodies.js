...
let music = new Audio('Moonlit Melodies/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Phir Mohabbat<br> <div class="subtitle">Mohd Irfan | Arijit | Saim Bhat</div>`,
        poster: "1.jpg"
    }
    ,
    {
    ...
    {
        id: 3,
        songName: `Guzarish <br> <div class="subtitle">Javed Ali · A.R. Rahman · Prasoon Joshi</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `Kya Mujhe Pyaar Hai <br> <div class="subtitle"> K.K · Pritam · Neelesh Misra</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
        songName: `Chand Sifarish <br> <div class="subtitle">Shaan · Kailash Kher</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
        songName: `Bheegi Bheegi <br> <div class="subtitle">James</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `Dil Ibadat<br> <div class="subtitle">KK, Pritam</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Maula Mere<br> <div class="subtitle">Roop Kumar Rathod</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Bol Na Halke Halke <br> <div class="subtitle">Rahat Fateh Ali Khan · Mahalaxmi Iyer</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `Tu Hi Meri Shab Hai <br> <div class="subtitle">KK</div>`,
        poster: "10.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Moonlit Melodies/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Moonlit Melodies/${index}.mp3`;
    poster_master_play.src = `Moonlit Melodies/${index}.jpg`;
    title_card.src = `Moonlit Melodies/${index}.jpg`
    banner.style.backgroundImage = `url('Moonlit Melodies/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Moonlit Melodies/${index}.mp3`;
