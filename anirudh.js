...
let music = new Audio('Anirudh/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Lokiverse <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "1.jpg"
    }
    ,
    {
        id: 2,
        songName: `Climax Fight <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "2.jpg"
    },
    {
        id: 3,
    ...
    {
        id: 4,
        songName: `Ordinary Person <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
    ...
    {
        id: 6,
        songName: `Badass <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `Bhavani Theme <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Lokiverse 2.0 <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Naan Naan <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
    ...
    {
        id: 11,
        songName: `Glimpse of Anthony Das <br> <div class="subtitle">Anirudh Ravichander</div>`,
        poster: "11.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Anirudh/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    ...
    poster_master_play.src = `Anirudh/${index}.jpg`;
    title_card.src = `Anirudh/${index}.jpg`
    banner.style.backgroundImage = `url('Anirudh/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Anirudh/${index}.mp3`;
