...
let music = new Audio('Downtown Drive/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Gang Up <br> <div class="subtitle">Young Thug, 2 Chainz</div>`,
        poster: "1.jpg"
    },
    {
        id: 2,
        songName: `Flawless 2 <br> <div class="subtitle">SKY x MYWAYBEATZ</div>`,
        poster: "2.jpg"
    },
    {
        id: 3,
        songName: `Ride Da Night <br> <div class="subtitle">Kevin Gates</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `Gangsta's Paradise ✘ Vur Yüreğim<br> <div class="subtitle">Coolio, LV</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
        songName: `I Won <br> <div class="subtitle">Ty Dolla $ign & Jack Harlow</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
        songName: `Go Off<br> <div class="subtitle">Lil Uzi Vert, Quavo & Travis Scott</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `Swan Song <br> <div class="subtitle">Saweetie & Niki</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Shadow Lady <br> <div class="subtitle">Dmitriy Protsenko</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Like That - Doja Cat ft. Gucci Mane <br> <div class="subtitle">Doja Cat ft. Gucci Mane</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `Space Cadet <br> <div class="subtitle">Metro Boomin (feat. Gunna)</div>`,
        poster: "10.jpg"
    },
    {
        id: 11,
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Downtown Drive/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Downtown Drive/${index}.mp3`;
    poster_master_play.src = `Downtown Drive/${index}.jpg`;
    title_card.src = `Downtown Drive/${index}.jpg`
    banner.style.backgroundImage = `url('Downtown Drive/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Downtown Drive/${index}.mp3`;
