...
let music = new Audio('On the Verge/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Specialz <br> <div class="subtitle">King Gnu</div>`,
        poster: "1.jpg"
    },
    {
        id: 2,
        songName: `Ashes On The Fire <br> <div class="subtitle">Kohta Yamamoto</div>`,
        poster: "2.jpg"
    },
    {
        id: 3,
        songName: `Number One - Bankai <br> <div class="subtitle"> Shiro Sagisu · Hazel Fernandes</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `Rengoku vs Akaza <br> <div class="subtitle">Marsal</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
        songName: `Hollow Purple <br> <div class="subtitle">Alisa Okehazama</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
        songName: `Suzume (feat. Toaka)<br> <div class="subtitle"> RADWIMPS · Toaka</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `Malevolent Shrine<br> <div class="subtitle">Yoshimasa Terui</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Sparkle (Your Name)<br> <div class="subtitle">Yojiro Noda</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Annihilate <br> <div class="subtitle">Metro Boomin · Swae Lee · Lil Wayne · Offset</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `T-KT (Attack on Titan) <br> <div class="subtitle">Hiroyuki Sawano</div>`,
        poster: "10.jpg"
    },
    {
        id: 11,
        songName: `What's Up Danger <br> <div class="subtitle">Blackway & Black Caviar</div>`,
        poster: "11.jpg"
    },
    {
        id: 12,
        songName: `La Espada (Bleach) <br> <div class="subtitle">Eternal Raijin</div>`,
        poster: "12.jpg"
    },
    {
        id: 13,
        songName: `Ｅｔｈｅｒｅａｌ <br> <div class="subtitle">Txmy</div>`,
        poster: "13.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="On the Verge/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `On the Verge/${index}.mp3`;
    poster_master_play.src = `On the Verge/${index}.jpg`;
    title_card.src = `On the Verge/${index}.jpg`
    banner.style.backgroundImage = `url('On the Verge/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `On the Verge/${index}.mp3`;
