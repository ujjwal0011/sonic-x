...
let music = new Audio('New Music/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Bade Miyan Chote Miyan (Title Track)<br> <div class="subtitle">Vishal Mishra, Anirudh Ravichander</div>`,
        poster: "1.jpg"
    }
    ,
    {
        id: 2,
        songName: `Heer Aasmani <br> <div class="subtitle">B Praak, Vishal Dadlani and Shekhar</div>`,
        poster: "2.jpg"
    },
    {
        id: 3,
        songName: `Akhiyan Gulab<br> <div class="subtitle">Mitraz</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `Nazar Teri Toofan<br> <div class="subtitle">Pritam, Papon, Varun Grover</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
        songName: `Lutt Putt Gaya<br> <div class="subtitle">Pritam, Arijit Singh</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
        songName: `Ishq Nachaawe<br> <div class="subtitle">Karan Kanchan, Rashmeet Kaur, YashRaj</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `Raat Akeli Thi<br> <div class="subtitle">Arijit Singh, Antara Mitra</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Saari Duniya Jalaa Denge (Extended Film Version)<br> <div class="subtitle">B Praak</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Mahadeva<br> <div class="subtitle">Kashh</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `Gallan<br> <div class="subtitle">Talwiinder · Mc Square</div>`,
        poster: "10.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="New Music/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `New Music/${index}.mp3`;
    poster_master_play.src = `New Music/${index}.jpg`;
    title_card.src = `New Music/${index}.jpg`
    banner.style.backgroundImage = `url('New Music/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `New Music/${index}.mp3`;
