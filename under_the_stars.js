...
let music = new Audio('Under The Stars/1.mp3')
...
let songs = [
    ...
    {
        id: 6,
        songName: `Him & I<br> <div class="subtitle"> G-Eazy · Halsey</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `I'm Yours<br> <div class="subtitle">Isabel LaRosa</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Summertime Sadness x I Wanna Be Yours<br> <div class="subtitle">Lana Del Rey, Arctic Monkeys</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Dancing With Your Ghost <br> <div class="subtitle">Sasha Alex Sloan</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Under The Stars/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Under The Stars/${index}.mp3`;
    poster_master_play.src = `Under The Stars/${index}.jpg`;
    title_card.src = `Under The Stars/${index}.jpg`
    banner.style.backgroundImage = `url('Under The Stars/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Under The Stars/${index}.mp3`;
