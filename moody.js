...
let music = new Audio('Moody/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Daylight <br> <div class="subtitle">David Kushner</div>`,
        poster: "1.jpg"
    }
    ,
    {
    ...
    {
        id: 3,
        songName: `Memory Reboot <br> <div class="subtitle">VØJ & Narvent</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `Hit The Road Jack <br> <div class="subtitle">2WEI</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
    ...
    {
        id: 7,
        songName: `The Fallen <br> <div class="subtitle">Playboi Carti</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Together Forever <br> <div class="subtitle">Yo Yo Honey Singh</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Last One Standing <br> <div class="subtitle">Skylar Grey ft. Polo G, Mozzy, & Eminem</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Moody/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Moody/${index}.mp3`;
    poster_master_play.src = `Moody/${index}.jpg`;
    title_card.src = `Moody/${index}.jpg`
    banner.style.backgroundImage = `url('Moody/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Moody/${index}.mp3`;
