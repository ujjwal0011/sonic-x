...
let music = new Audio('Amnesia/1.mp3')

let songs = [
    {
        id: 1,
        songName: `Flight - Man of Steel <br> <div class="subtitle">Hanz Zimmer</div>`,
        poster: "1.jpg"
    },
    {
        id: 2,
        songName: `Cornfield Chase <br> <div class="subtitle">Hanz Zimmer</div>`,
        poster: "2.jpg"
    },
    {
        id: 3,
        songName: `Goodbye - Dark <br> <div class="subtitle">Appart</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `Can You Hear The Music <br> <div class="subtitle">Ludwig Göransson</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
        songName: `The Electro Suite <br> <div class="subtitle">Hanz Zimmer</div>`,
        poster: "5.jpg"
    },
    {
        id: 6,
        songName: `Goblin - Amnesia<br> <div class="subtitle">Chanyeol</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
        songName: `Together - Attack on Titan <br> <div class="subtitle">Hiroyuki Sawano</div>`,
        poster: "7.jpg"
    },
    {
        id: 8,
        songName: `Loki Green Theme <br> <div class="subtitle">Natalie Holt</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `History Is Now <br> <div class="subtitle">Natalie Holt</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `Can't Fight City Halloween <br> <div class="subtitle">Michael Giacchino</div>`,
        poster: "10.jpg"
    },
    {
        id: 11,
        songName: `Summon the Suit <br> <div class="subtitle">Hesham Nazih</div>`,
        poster: "11.jpg"
    },
    {
        id: 12,
        songName: `Worm Ride <br> <div class="subtitle">Hanz Zimmer</div>`,
        poster: "12.jpg"
    },
    {
        id: 13,
        songName: `Goth <br> <div class="subtitle">Sidewalks & Skeletons</div>`,
        poster: "13.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Amnesia/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Amnesia/${index}.mp3`;
    poster_master_play.src = `Amnesia/${index}.jpg`;
    title_card.src = `Amnesia/${index}.jpg`
    banner.style.backgroundImage = `url('Amnesia/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Amnesia/${index}.mp3`;
