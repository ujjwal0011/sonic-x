...
let music = new Audio('Lost On You/1.mp3')

let songs = [
    {
        id: 1,
        songName: `NCA - Andro <br> <div class="subtitle">Andro</div>`,
        poster: "1.jpg"
    },
    {
        id: 2,
    ...
    {
        id: 3,
        songName: `Dynasty <br> <div class="subtitle">Mia</div>`,
        poster: "3.jpg"
    },
    {
        id: 4,
        songName: `We Don't Talk Anymore<br> <div class="subtitle">Charlie Puth & Selena Gomez</div>`,
        poster: "4.jpg"
    },
    {
        id: 5,
    ...
    {
        id: 6,
        songName: `Harleys in Hawai<br> <div class="subtitle">Katy Perry</div>`,
        poster: "6.jpg"
    },
    {
        id: 7,
    ...
    {
        id: 8,
        songName: `Dangerously <br> <div class="subtitle">Charlie Puth</div>`,
        poster: "8.jpg"
    },
    {
        id: 9,
        songName: `Set Fire to the Rain x Another Love <br> <div class="subtitle">Adele & Tom Odell</div>`,
        poster: "9.jpg"
    },
    {
        id: 10,
        songName: `The Night We Met<br> <div class="subtitle">Lord Huron</div>`,
        poster: "10.jpg"
    }
]
...
songs.forEach(element => {
    ...
    card.href = "#" + id;
    card.innerHTML = `<img src="Lost On You/${poster}" alt="">
                            <div class="con">
                              ${songName}
                        </div>`
...
function changeSong(index) {
    music.src = `Lost On You/${index}.mp3`;
    poster_master_play.src = `Lost On You/${index}.jpg`;
    title_card.src = `Lost On You/${index}.jpg`
    banner.style.backgroundImage = `url('Lost On You/${index}.jpg')`;
    music.play();
    play_btn.classList.remove('bi-play-fill');
    play_btn.classList.add('bi-pause-fill');
    download.href = `Lost On You/${index}.mp3`;
